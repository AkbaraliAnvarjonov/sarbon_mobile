...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    data = json['data'] != null ? FavouriteCargoData.fromJson(json['data']) : null;
...
class FavouriteCargoData {
  int? count;
  List<FavouriteCargoItem>? response;
  ...
  FavouriteCargoData.fromJson(Map<String, dynamic> json) {
    count = json['count'];
    if (json['response'] != null) {
      response = <FavouriteCargoItem>[];
      json['response'].forEach((v) {
        response!.add(FavouriteCargoItem.fromJson(v));
      });
    }
  }
...
class FavouriteCargoItem {
  ...
  FavouriteCargoItem.fromJson(Map<String, dynamic> json) {
