class TypeCurrencyResponse {
  ...
  TypeCurrencyResponse.fromJson(Map json) {
    status = json['status'];
  ...
  Data.fromJson(Map json) {
    ...
    if (json['response'] != null) {
      ...
      json['response'].forEach((v) {
        response?.add(CurrencyListResponse.fromJson(v));
      });
    }
  }

  num? count;
  List<CurrencyListResponse>? response;
...
class CurrencyListResponse {
  ...
  CurrencyListResponse.fromJson(Map json) {
    code = json['code'];
    guid = json['guid'];
    name = json['name'];
    photo = json['photo'];
