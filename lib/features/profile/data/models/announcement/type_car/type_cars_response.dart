class TypeCarsResponse {
  ...
  TypeCarsResponse.fromJson(Map json) {
    status = json['status'];
  ...
  Data.fromJson(Map json) {
    ...
    if (json['response'] != null) {
      ...
      json['response'].forEach((v) {
        response?.add(TypeCarsListResponse.fromJson(v));
      });
    }
  }

  num? count;
  List<TypeCarsListResponse>? response;
...
class TypeCarsListResponse {
  TypeCarsListResponse({
    this.guid,
    this.name,
    this.vehicleDeataileType,
  });

  TypeCarsListResponse.fromJson(Map json) {
    guid = json['guid'];
    name = json['name'];
