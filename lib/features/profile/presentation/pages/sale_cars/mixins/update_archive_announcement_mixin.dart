part of '../sale_cars_sub_pages/my_announcement/announcement_tab_pages/sub_pages/update_archive_announcement_page.dart';

mixin UpdateArchiveAnnouncementMixin on State<UpdateArchiveAnnouncementPage> {
  late UpdateArchiveAnnouncementBloc _updateArchiveAnnouncementBloc;
  ...
  void initState() {
    _updateArchiveAnnouncementBloc =
        context.read<UpdateArchiveAnnouncementBloc>();
    setInitialValues();
    super.initState();
  }
