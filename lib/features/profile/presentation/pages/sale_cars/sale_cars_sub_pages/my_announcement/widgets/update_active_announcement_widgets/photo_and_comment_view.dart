...
class _PhotoAndCommentViewWidget extends StatelessWidget {
  const _PhotoAndCommentViewWidget({
    ...
    required this.updateActiveAnnouncementBloc,
    required this.imageUrl,
  });

  final TextEditingController descriptionController;
  final UpdateActiveAnnouncementBloc updateActiveAnnouncementBloc;
  ...
  Widget build(BuildContext context) => Column(
        ...
        children: [
          ...
          AppUtils.kGap6,
          BlocBuilder<UpdateActiveAnnouncementBloc,
            ...
            builder: (context, state) => GestureDetector(
              onTap: () async {
                await ImagePicker().pickImage(source: ImageSource.gallery).then(
                  (value) {
                    if (value != null) {
                      updateActiveAnnouncementBloc.add(
                        SelectImageEvent(
