...
import '../../../../../../bloc/update_archive_announcement/update_archive_announcement_bloc.dart';

part '../../../../mixins/update_archive_announcement_mixin.dart';

part '../../widgets/update_archive_announcement_widgets/select_items_type.dart';

part '../../widgets/update_archive_announcement_widgets/select_address_view.dart';

part '../../widgets/update_archive_announcement_widgets/select_car_type_view.dart';

part '../../widgets/update_archive_announcement_widgets/input_car_name_view.dart';

part '../../widgets/update_archive_announcement_widgets/photo_and_comment_view.dart';

part '../../widgets/update_archive_announcement_widgets/price_and_contact_view.dart';

part '../../widgets/update_archive_announcement_widgets/update_announcement_button_view.dart';

class UpdateArchiveAnnouncementPage extends StatefulWidget {
  const UpdateArchiveAnnouncementPage({
    super.key,
  ...
  @override
  State<UpdateArchiveAnnouncementPage> createState() =>
      _UpdateArchiveAnnouncementPageState();
}

class _UpdateArchiveAnnouncementPageState
    extends State<UpdateArchiveAnnouncementPage>
    with UpdateArchiveAnnouncementMixin {
  @override
  Widget build(BuildContext context) => Scaffold(
        appBar: AppBar(
          title: Text('archived_publication'.tr()),
          scrolledUnderElevation: 0,
        ),
        body: BlocListener<UpdateArchiveAnnouncementBloc,
          ...
          child: BlocBuilder<UpdateArchiveAnnouncementBloc,
              UpdateArchiveAnnouncementState>(
                          ...
                          [
                            ...
                            _PhotoAndCommentViewWidget(
                              ...
                              updateArchiveAnnouncementBloc:
                                  _updateArchiveAnnouncementBloc,
        ...
        bottomNavigationBar: _UpdateArchiveAnnouncementButtonViewWidget(
          formKey: _formKey,
          nameController: nameController,
          descriptionController: descriptionController,
          priceController: priceController,
          phoneController: phoneController,
          updateAnnouncementBloc: _updateArchiveAnnouncementBloc,
