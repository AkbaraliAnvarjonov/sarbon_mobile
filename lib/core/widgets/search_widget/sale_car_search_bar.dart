...
mixin ControllerListener<T> on State<SaleCarSearchBar<T>> {
...
class SaleCarSearchBar<T> extends StatefulWidget {
  const SaleCarSearchBar({
    super.key,
    ...
    required this.recommendationBuilder,
  });
  ...
  final Widget recommendationBuilder;
  ...
  @override
  SaleCarSearchBarState createState() => SaleCarSearchBarState<T>();
}

class SaleCarSearchBarState<T> extends State<SaleCarSearchBar<T>>
  ...
  Widget _buildOnItemFound(
    List<T?> items,
    Widget Function(T? item, int index) foundItmBuilder,
        ...
        slivers: [
          ...
          SliverPadding(
            ...
            sliver: SliverList.separated(
              itemBuilder: (context, index) => foundItmBuilder(
                items[index],
                index,
              ),
              itemCount: items.length,
  ...
  Widget? _buildContent() {
    ...
    } else if (_list.isNotEmpty && _searchQueryController.text.isNotEmpty) {
      return _buildOnItemFound(
        _list,
        widget.onItemFound,
        widget.recommendationBuilder,
      );
          ...
          Material(
            ...
            child: Padding(
              ...
              child: TextFormField(
                ...
                onFieldSubmitted: _onTextChanged,
                ...
                decoration: InputDecoration(
                  ...
                  contentPadding:
                      widget.contentPadding ?? AppUtils.kPaddingAll12,
                  errorBorder: OutlineInputBorder(
                    borderSide: widget.haveBorder
